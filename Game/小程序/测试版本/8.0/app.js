...
App({
  globalData: {
    ...
    cropConfig: {
      ...
      cotton:   { name: '棉花',   growTime: 20, price: 60, seedPrice: 22, unlockLevel: 6, expReward: 28, emoji: '🧵', color: '#F5F5F5', type: 'base' },
      grape:    { name: '葡萄',   growTime: 22, price: 70, seedPrice: 25, unlockLevel: 7, expReward: 35, emoji: '🍇', color: '#7B1FA2', type: 'base' },
      coffee:   { name: '咖啡',   growTime: 25, price: 85, seedPrice: 30, unlockLevel: 7, expReward: 40, emoji: '☕', color: '#5D4037', type: 'base' },
      melon:    { name: '蜜瓜',   growTime: 24, price: 75, seedPrice: 28, unlockLevel: 7, expReward: 38, emoji: '🍈', color: '#8BC34A', type: 'base' },
    },
